...
def test_rc2_version_identity() -> None:
    ...
    assert 'version = "0.17.1rc2"' in Path("pyproject.toml").read_text(encoding="utf-8")
    assert "0.17.1-rc2" in Path("packaging/windows/version_info.txt").read_text(encoding="utf-8")

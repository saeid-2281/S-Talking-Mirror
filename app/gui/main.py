...
class MainWindow(QMainWindow):
    ...
    def build_main_toolbar(self):
        ...
        for name in ['Generation History','Launch Receipts','Approval Operations','Open Latest Report','Provider accounts','Pronunciation dictionaries','Command Palette','Export Diagnostics','Restore Default Layout']:
            action=self.actions_by_name.get(name)

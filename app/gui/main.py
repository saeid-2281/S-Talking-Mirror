...
class MainWindow(QMainWindow):
    ...
    def export_diagnostics_for(self,report_dir): bundle=self.report_service.export_diagnostics_bundle(report_dir); self.open_path(bundle.parent); self.copy_path(bundle)
